...
relatorio_bp = Blueprint('usuario', __name__)


@relatorio_bp.route('/listar', methods=['GET'])
def listar_usuarios():
    try:
...
@relatorio_bp.route('/criar', methods=['POST'])
...
@relatorio_bp.route('/buscar/<int:usuario_id>', methods=['GET'])
...
@relatorio_bp.route('/deletar/<int:usuario_id>', methods=['DELETE'])
...
@relatorio_bp.route('/atualizar/<int:usuario_id>', methods=['PUT'])
...
@relatorio_bp.route('/signin', methods=['POST'])
def sign_in_usuario():
    try:
        data = request.get_json()
        email = data['email']
