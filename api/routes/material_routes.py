...
material_bp = Blueprint('usuario', __name__)
...
@material_bp.route('/buscar/<int:usuario_id>', methods=['GET'])
...
@material_bp.route('/deletar/<int:usuario_id>', methods=['DELETE'])
...
@material_bp.route('/atualizar/<int:usuario_id>', methods=['PUT'])
...
@material_bp.route('/signin', methods=['POST'])
def sign_in_usuario():
    try:
        data = request.get_json()
        email = data['email']
